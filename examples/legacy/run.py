...
Usage:
    python -m examples.legacy.run              # production-style, no reload
    python -m examples.legacy.run --reload     # development hot-reload
    uvicorn examples.legacy.run:app --host 0.0.0.0 --port 8000 --reload
"""
